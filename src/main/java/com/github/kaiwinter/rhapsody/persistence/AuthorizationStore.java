...
/**
 * Implementations of this class persists the {@link AuthorizationInfo} of a logged in user. This can be used to log in the user
 * automatically after a first successful login.
 */
public interface AuthorizationStore {

	/**
	 * Loads the previously saved authentication information. If no values were saved the returned object contains <code>null</code> values.
	 * 
